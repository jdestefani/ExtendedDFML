...
usethis::use_data(DIMENSIONALITY_METHODS,
                  INCREMENTAL_DIMENSIONALITY_METHODS,
                  INCREMENTAL_PCA_METHODS,
                  NO_EMBEDDING_METHODS,
                  REQUIRE_EMBEDDING_METHODS,
                  AUTOENCODER_METHODS,
                  FORECAST_FAMILY,
                  MULTISTEPAHEAD_METHODS,
                  M4_METHODS,
                  GRADIENT_BOOSTING_METHODS,
                  FORECAST_METHODS, 
                  internal = T,
                  overwrite = T)
